...
const PLAY_TRANSLATIONS = {
  es: {
    game_started: "Se ha iniciado una nueva partida de Los Juegos del Hambre. La partida comienza <t:{time}:R>.",
  ...
  en: {
    game_started: "A new Hunger Games battle has started. Battle is starting <t:{time}:R>.",
