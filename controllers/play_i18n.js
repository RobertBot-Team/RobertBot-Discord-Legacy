...
const PLAY_TRANSLATIONS = {
  ...
  en: {
    game_started: "A new Hunger Games match has started",
    already_running: "There is already a match in progress",
    wait_timeout: "Waiting time is over. Please start a new match.",
    ...
    already_joined: "You have already joined this match",
    joined_count: "{count} players joined\n {playersList}",
    battle_coming: "The battle is coming",
    game_starting: "The match starts now",
    ...
    no_permission_change_mode: "You do not have permission to change match mode.",
    ...
    stop_by_staff: "{nick} stopped the Hunger Games match.",
    stop_no_permission: "Nice try, only Staff can stop a match.",
  },
};
