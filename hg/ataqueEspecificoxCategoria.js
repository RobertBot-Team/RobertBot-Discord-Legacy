...
eventosAtaqueEspecificoxCategoria[19] = async (jugador, players, victima, req, channel, playersReal)=>{
  let evento = ` ${jugador.getNombre()} invoca onis con su Tridente demoníaco para que ataquen a ${victima.getNombre()}, pero son tan onis que terminan atacando a ${jugador.getNombre()}`;
  console.log(evento);
