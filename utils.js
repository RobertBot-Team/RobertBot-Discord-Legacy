...
const martilloThor = new Arma("martillo de Thor", "martillo de Thor", 500, 2, "m", "", "Thor Hammer");
...
const estrellasNinja = new Arma("estrellas ninja", "estrellas", 100, 3, "f", "p", "shuriken");
...
const tridente = new Arma("tridente demoníaco", "tridente demoníaco", 300, 3, "m", "", "demoniac trident");
const lapiz = new Arma("lápiz", "arma blanca", 10, 1, "m", "", "pencil");
const ballesta = new Arma("ballesta", "arco y flecha", 100, 4, "f", "", "crossbow");
const dardosVenenosos = new Arma("dardos venenosos", "veneno", 175, 3, "m", "p", "poison darts");
...
const fuegosArtificiales = new Arma("fuegos artificiales", "explosivos", 170, 1, "m", "p", "fireworks");
...
const nunchaku = new Arma("nunchaku", "nunchaku", 50, 8, "m", "", "nunchucks");
...
const agujas = new Arma("agujas", "arma blanca", 50, 10, "f", "p", "needles");
...
const tijeras = new Arma("tijeras", "tijeras", 25, 2, "f", "p", "scissors");
...
const abanico = new Arma("abanico", "abanico", 19, 3, "m", "", "fan");
const ganzuas = new Arma("ganzúas", "ganzúas", 62, 5, "f", "p", "lockpicks");
const tijerasJardineria = new Arma("tijeras de jardinería", "tijeras de jardineria", 89, 6, "f", "p", "gardening shears");
...
const palillos = new Arma("palillos chinos", "palillos chinos", 51, 1, "m", "p", "chopsticks");
const excalibur = new Arma("Excalibur", "espada", 415, 2, "f", "", "Excalibur");
...
const aspaVentilador = new Arma("aspa de ventilador", "aspa de ventilador", 100, 2, "m", "", "fan blade");
const rama = new Arma("rama", "rama", 30, 3, "f", "", "branch");
const cadenas = new Arma("cadenas", "cadenas", 120, 2, "f", "p", "chains");
const esposas = new Arma("esposas", "esposas", 20, 3, "f", "p", "handcuffs");
...
const dentadura = new Arma("dentadura", "dentadura", 8, 2, "f", "", "dentures");
...
const bongos = new Arma("bongos", "rompibles", 100, 4, "m", "p", "bongos");
...
const tnt = new Arma("TNT", "explosivos", 300, 1, "m", "", "TNT");
